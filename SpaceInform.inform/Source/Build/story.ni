...
Engineer's Journal Entry is a thing. It is in the Engineer's footlocker. The description is "All of these infernal Marines climbing over my ship, making a mess of the place. And to top it all off the Power Generator is on the frtiz. What a week.".
...
The Power Console is in then Engine Room. The power console is broken.

A page is a kind of thing.
There is a page called power generator info. Understand "51234" as power generator info.

Understand "lookup [something]" as lookup.

lookup is an action applying to one thing.

Check lookup:
	if the Engineer's manual is not carried:
		say "You don't have anything to lookup in." instead.
